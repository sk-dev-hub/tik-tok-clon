<template>
    <div
        id="AuthOverlay"
        class="fixed flex items-center z-50 top-0 left-0 w-full h-full bg-black bg-opacity-50"
    >
        <div class="relative bg-white w-full mx-auto max-w-[470px] h-[70%] p-4 rounded-lg">
